...
const MobileSidebar = React.memo(() => {
  ...
  return (
    <aside
      className={`absolute top-0 left-0 bg-gray-200 h-screen w-3/4  rounded-r-lg transition-all ease-in duration-200 z-10 flex-col border-r dark:bg-slate-800 dark:border-r-white
